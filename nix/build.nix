...
stdenv.mkDerivation (finalAttrs: {
  ...
  pnpmDeps = fetchPnpmDeps {
    ...
    src = finalAttrs.src;
    fetcherVersion = 3;
    hash = "sha256-zbPL37i7M0zD6mDhWl66M0b3CGcRXpJgh429DY7c2YY=";
  };
  ...
  buildPhase = ''
    ...
    # Hack: pass `--nodedir` directly. pnpm v11 doesn't seem to pass `npm_config_*` and
    # `npm_package_config_*` env vars to postinstall hooks
    substituteInPlace ./node_modules/.pnpm/re2*/node_modules/re2/package.json \
      --replace-fail 'node-gyp ' 'node-gyp --nodedir ${nodejs} '
